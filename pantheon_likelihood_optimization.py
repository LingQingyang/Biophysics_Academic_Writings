...
def verification_test():
    """
    Check unit3 codes accuracy
    """
    print("--- Verifying Cosmology Class ---")
    
    # Case 1
    # mu(z=0.5) = 42.61580 for Om=0.25, Ol=0.7, H0=60.0
    c1 = Cosmology(H0=60.0, Omega_m=0.25, Omega_lambda=0.7)
    mu1 = c1.distance_modulus(0.5, n=1000, c=299792.458) 
    print(f"Case 1 (Target: 42.61580): {mu1:.5f}")

    # Case 2
    # mu(z=1.0) = 44.10024 for Om=0.3, Ol=0.7, H0=70.0
    c2 = Cosmology(H0=70.0, Omega_m=0.3, Omega_lambda=0.7)
    mu2 = c2.distance_modulus(1.0, n=1000, c=299792.458)
    print(f"Case 2 (Target: 44.10024): {mu2:.5f}")

    # Case 3
    # mu(z=1.5) = 44.76602 for Om=0.4, Ol=0.65, H0=80.0
    c3 = Cosmology(H0=80.0, Omega_m=0.4, Omega_lambda=0.65)
    mu3 = c3.distance_modulus(1.5, n=1000, c=299792.458)
    print(f"Case 3 (Target: 44.76602): {mu3:.5f}")
